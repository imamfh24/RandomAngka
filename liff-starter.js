window.onload = function() {
    ...
    const defaultLiffId = "1653902490-xn8lm6Jr";   // change the default LIFF value if you are not using a node server
...
function displayIsInClientInfo() {
    if (liff.isInClient()) {
        ...
        document.getElementById('liffLogoutButton').classList.toggle('hidden');
        document.getElementById('isInClientMessage').textContent = 'Kamu membuka aplikasi ini didalam browser internal LINE.';
    } else {
        document.getElementById('isInClientMessage').textContent = 'Kamu membuka aplikasi ini di browser eksternal.';
    }
}
